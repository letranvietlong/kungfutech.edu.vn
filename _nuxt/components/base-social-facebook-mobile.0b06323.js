  ...
  [18, 28],
  {
        ...
        N = {
          ...
          methods: {
            ...
            closeViewer: function () {
              (document.body.style.overflow = Y), (this.showViewer = !1);
            },
          },
        },
        B = (n(523), n(10)),
    ...
    657: function (e, t, n) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[e.i, content, ""]]),
        content.locals && (e.exports = content.locals);
      (0, n(4).default)("7c405ffc", content, !0, { sourceMap: !1 });
    },
    771: function (e, t, n) {
      "use strict";
      n(657);
    ...
    772: function (e, t, n) {
      ...
      r.push([
        e.i,
        ".fade-in-linear-enter-active[data-v-9e688a08],.fade-in-linear-leave-active[data-v-9e688a08]{transition:opacity 200ms linear}.fade-in-linear-enter[data-v-9e688a08],.fade-in-linear-leave[data-v-9e688a08],.fade-in-linear-leave-active[data-v-9e688a08]{opacity:0}.el-fade-in-linear-enter-active[data-v-9e688a08],.el-fade-in-linear-leave-active[data-v-9e688a08]{transition:opacity 200ms linear}.el-fade-in-linear-enter[data-v-9e688a08],.el-fade-in-linear-leave[data-v-9e688a08],.el-fade-in-linear-leave-active[data-v-9e688a08]{opacity:0}.el-fade-in-enter-active[data-v-9e688a08],.el-fade-in-leave-active[data-v-9e688a08]{transition:all .3s cubic-bezier(0.55, 0, 0.1, 1)}.el-fade-in-enter[data-v-9e688a08],.el-fade-in-leave-active[data-v-9e688a08]{opacity:0}.el-zoom-in-center-enter-active[data-v-9e688a08],.el-zoom-in-center-leave-active[data-v-9e688a08]{transition:all .3s cubic-bezier(0.55, 0, 0.1, 1)}.el-zoom-in-center-enter[data-v-9e688a08],.el-zoom-in-center-leave-active[data-v-9e688a08]{opacity:0;transform:scaleX(0)}.el-zoom-in-top-enter-active[data-v-9e688a08],.el-zoom-in-top-leave-active[data-v-9e688a08]{opacity:1;transform:scaleY(1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:center top}.el-zoom-in-top-enter[data-v-9e688a08],.el-zoom-in-top-leave-active[data-v-9e688a08]{opacity:0;transform:scaleY(0)}.el-zoom-in-bottom-enter-active[data-v-9e688a08],.el-zoom-in-bottom-leave-active[data-v-9e688a08]{opacity:1;transform:scaleY(1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:center bottom}.el-zoom-in-bottom-enter[data-v-9e688a08],.el-zoom-in-bottom-leave-active[data-v-9e688a08]{opacity:0;transform:scaleY(0)}.el-zoom-in-left-enter-active[data-v-9e688a08],.el-zoom-in-left-leave-active[data-v-9e688a08]{opacity:1;transform:scale(1, 1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:top left}.el-zoom-in-left-enter[data-v-9e688a08],.el-zoom-in-left-leave-active[data-v-9e688a08]{opacity:0;transform:scale(0.45, 0.45)}.collapse-transition[data-v-9e688a08]{transition:.3s height ease-in-out,.3s padding-top ease-in-out,.3s padding-bottom ease-in-out}.horizontal-collapse-transition[data-v-9e688a08]{transition:.3s width ease-in-out,.3s padding-left ease-in-out,.3s padding-right ease-in-out}.el-list-enter-active[data-v-9e688a08],.el-list-leave-active[data-v-9e688a08]{transition:all 1s}.el-list-enter[data-v-9e688a08],.el-list-leave-active[data-v-9e688a08]{opacity:0;transform:translateY(-30px)}.el-opacity-transition[data-v-9e688a08]{transition:opacity .3s cubic-bezier(0.55, 0, 0.1, 1)}.image[data-v-9e688a08],.link[data-v-9e688a08]{width:100%}.image[data-v-9e688a08]{margin-bottom:1.3rem}@media(min-width: 768px){.facebook-mobile[data-v-9e688a08]{display:none}}",
        "",
      ]),
        (e.exports = r);
    },
          ...
          data: function () {
            return {
              image: this.isArticle
                ? "/v1644200865/assets/facebookmobile_xnj4ht.png"
                : "/v1639363076/assets/facebook-mobile_ipj0df.svg",
            };
          },
          computed: {
            imageUrl: function () {
        ...
        component = Object(o.a)(
          ...
          function () {
            ...
            return n(
              "a",
              {
                staticClass: "link facebook-mobile",
                attrs: {
                  rel: "noopener",
