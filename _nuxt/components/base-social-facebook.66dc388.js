(window.webpackJsonp = window.webpackJsonp || []).push([
  [17, 28],
  {
    ...
    522: function (e, t, n) {
      ...
      const z = r.default.prototype.$isServer,
        _ = /([\:\-\_]+(.))/g,
        L = /^moz([A-Z])/,
        x = z ? 0 : Number(document.documentMode),
        S = function (e) {
          return e
            .replace(_, function (e, t, n, r) {
        ...
        B = {
          ...
          computed: {
            ...
            alignCenter: function () {
              return !this.$isServer && !H() && this.fit !== T;
            },
            preview: function () {
    ...
    656: function (e, t, n) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[e.i, content, ""]]),
        content.locals && (e.exports = content.locals);
      (0, n(4).default)("44bcdfe8", content, !0, { sourceMap: !1 });
    },
    769: function (e, t, n) {
      "use strict";
      n(656);
    ...
    770: function (e, t, n) {
      ...
      r.push([
        e.i,
        ".fade-in-linear-enter-active[data-v-08ee2658],.fade-in-linear-leave-active[data-v-08ee2658]{transition:opacity 200ms linear}.fade-in-linear-enter[data-v-08ee2658],.fade-in-linear-leave[data-v-08ee2658],.fade-in-linear-leave-active[data-v-08ee2658]{opacity:0}.el-fade-in-linear-enter-active[data-v-08ee2658],.el-fade-in-linear-leave-active[data-v-08ee2658]{transition:opacity 200ms linear}.el-fade-in-linear-enter[data-v-08ee2658],.el-fade-in-linear-leave[data-v-08ee2658],.el-fade-in-linear-leave-active[data-v-08ee2658]{opacity:0}.el-fade-in-enter-active[data-v-08ee2658],.el-fade-in-leave-active[data-v-08ee2658]{transition:all .3s cubic-bezier(0.55, 0, 0.1, 1)}.el-fade-in-enter[data-v-08ee2658],.el-fade-in-leave-active[data-v-08ee2658]{opacity:0}.el-zoom-in-center-enter-active[data-v-08ee2658],.el-zoom-in-center-leave-active[data-v-08ee2658]{transition:all .3s cubic-bezier(0.55, 0, 0.1, 1)}.el-zoom-in-center-enter[data-v-08ee2658],.el-zoom-in-center-leave-active[data-v-08ee2658]{opacity:0;transform:scaleX(0)}.el-zoom-in-top-enter-active[data-v-08ee2658],.el-zoom-in-top-leave-active[data-v-08ee2658]{opacity:1;transform:scaleY(1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:center top}.el-zoom-in-top-enter[data-v-08ee2658],.el-zoom-in-top-leave-active[data-v-08ee2658]{opacity:0;transform:scaleY(0)}.el-zoom-in-bottom-enter-active[data-v-08ee2658],.el-zoom-in-bottom-leave-active[data-v-08ee2658]{opacity:1;transform:scaleY(1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:center bottom}.el-zoom-in-bottom-enter[data-v-08ee2658],.el-zoom-in-bottom-leave-active[data-v-08ee2658]{opacity:0;transform:scaleY(0)}.el-zoom-in-left-enter-active[data-v-08ee2658],.el-zoom-in-left-leave-active[data-v-08ee2658]{opacity:1;transform:scale(1, 1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:top left}.el-zoom-in-left-enter[data-v-08ee2658],.el-zoom-in-left-leave-active[data-v-08ee2658]{opacity:0;transform:scale(0.45, 0.45)}.collapse-transition[data-v-08ee2658]{transition:.3s height ease-in-out,.3s padding-top ease-in-out,.3s padding-bottom ease-in-out}.horizontal-collapse-transition[data-v-08ee2658]{transition:.3s width ease-in-out,.3s padding-left ease-in-out,.3s padding-right ease-in-out}.el-list-enter-active[data-v-08ee2658],.el-list-leave-active[data-v-08ee2658]{transition:all 1s}.el-list-enter[data-v-08ee2658],.el-list-leave-active[data-v-08ee2658]{opacity:0;transform:translateY(-30px)}.el-opacity-transition[data-v-08ee2658]{transition:opacity .3s cubic-bezier(0.55, 0, 0.1, 1)}.image[data-v-08ee2658],.link[data-v-08ee2658]{width:100%}.image[data-v-08ee2658]{margin-bottom:1.3rem}@media(max-width: 768px){.facebook[data-v-08ee2658]{display:none}}",
        "",
      ]),
        (e.exports = r);
    },
    867: function (e, t, n) {
      ...
      var r = {
          props: {
            isArticle: { type: Boolean, default: !1 },
            isFpt: { type: Boolean, default: !1 },
          },
          data: function () {
            return {
              image: this.isArticle
                ? "/v1644083720/assets/fb2_i8f0gz.png"
                : this.isFpt
                ? "/v1644204067/assets/fbmo_yx277y.png"
                : "/v1638646478/assets/facebook_bvj95a.svg",
            };
          },
          computed: {
            imageUrl: function () {
                ...
                n(
                  "CoreImage",
                  {
                    ...
                    attrs: {
                      ...
                      lazy: "",
                      src: e.imageUrl,
                      alt: "Group cộng đồng lập trình viên Việt Nam",
                    },
                  },
                  [
                    n(
