(window.webpackJsonp = window.webpackJsonp || []).push([
  [54],
  {
    ...
    669: function (n, e, t) {
      ...
      (0, t(4).default)("f08ef46c", content, !0, { sourceMap: !1 });
    },
    798: function (n, e, t) {
      "use strict";
      t(669);
    ...
    799: function (n, e, t) {
      ...
      c.push([
        n.i,
        ".fade-in-linear-enter-active[data-v-81c7e062],.fade-in-linear-leave-active[data-v-81c7e062]{transition:opacity 200ms linear}.fade-in-linear-enter[data-v-81c7e062],.fade-in-linear-leave[data-v-81c7e062],.fade-in-linear-leave-active[data-v-81c7e062]{opacity:0}.el-fade-in-linear-enter-active[data-v-81c7e062],.el-fade-in-linear-leave-active[data-v-81c7e062]{transition:opacity 200ms linear}.el-fade-in-linear-enter[data-v-81c7e062],.el-fade-in-linear-leave[data-v-81c7e062],.el-fade-in-linear-leave-active[data-v-81c7e062]{opacity:0}.el-fade-in-enter-active[data-v-81c7e062],.el-fade-in-leave-active[data-v-81c7e062]{transition:all .3s cubic-bezier(0.55, 0, 0.1, 1)}.el-fade-in-enter[data-v-81c7e062],.el-fade-in-leave-active[data-v-81c7e062]{opacity:0}.el-zoom-in-center-enter-active[data-v-81c7e062],.el-zoom-in-center-leave-active[data-v-81c7e062]{transition:all .3s cubic-bezier(0.55, 0, 0.1, 1)}.el-zoom-in-center-enter[data-v-81c7e062],.el-zoom-in-center-leave-active[data-v-81c7e062]{opacity:0;transform:scaleX(0)}.el-zoom-in-top-enter-active[data-v-81c7e062],.el-zoom-in-top-leave-active[data-v-81c7e062]{opacity:1;transform:scaleY(1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:center top}.el-zoom-in-top-enter[data-v-81c7e062],.el-zoom-in-top-leave-active[data-v-81c7e062]{opacity:0;transform:scaleY(0)}.el-zoom-in-bottom-enter-active[data-v-81c7e062],.el-zoom-in-bottom-leave-active[data-v-81c7e062]{opacity:1;transform:scaleY(1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:center bottom}.el-zoom-in-bottom-enter[data-v-81c7e062],.el-zoom-in-bottom-leave-active[data-v-81c7e062]{opacity:0;transform:scaleY(0)}.el-zoom-in-left-enter-active[data-v-81c7e062],.el-zoom-in-left-leave-active[data-v-81c7e062]{opacity:1;transform:scale(1, 1);transition:transform 300ms cubic-bezier(0.23, 1, 0.32, 1),opacity 300ms cubic-bezier(0.23, 1, 0.32, 1);transform-origin:top left}.el-zoom-in-left-enter[data-v-81c7e062],.el-zoom-in-left-leave-active[data-v-81c7e062]{opacity:0;transform:scale(0.45, 0.45)}.collapse-transition[data-v-81c7e062]{transition:.3s height ease-in-out,.3s padding-top ease-in-out,.3s padding-bottom ease-in-out}.horizontal-collapse-transition[data-v-81c7e062]{transition:.3s width ease-in-out,.3s padding-left ease-in-out,.3s padding-right ease-in-out}.el-list-enter-active[data-v-81c7e062],.el-list-leave-active[data-v-81c7e062]{transition:all 1s}.el-list-enter[data-v-81c7e062],.el-list-leave-active[data-v-81c7e062]{opacity:0;transform:translateY(-30px)}.el-opacity-transition[data-v-81c7e062]{transition:opacity .3s cubic-bezier(0.55, 0, 0.1, 1)}.wrap[data-v-81c7e062]{margin-bottom:4rem}.title[data-v-81c7e062]{font-size:2.5rem;color:#1f2937}.wrap-empty[data-v-81c7e062]{margin-top:2rem;display:flex;justify-content:center}.link[data-v-81c7e062]{color:#6b7280;margin-left:.5rem;margin-top:.5rem}.link[data-v-81c7e062]:hover{color:#1f2937}",
        "",
      ]),
        (n.exports = c);
    },
    878: function (n, e, t) {
      ...
      var c = t(5),
        ...
        v = {
          data: function () {
            return { activeName: "", languages: r.b, data: [] };
          },
          computed: {
            getCategory: function () {
              return "0" === this.activeName ? "" : this.activeName;
            },
          },
          fetch: function () {
            var n = this;
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (e.next = 2),
                            n
                              .$content("/document".concat(n.getCategory), {
                                deep: !0,
                              })
        ...
        component = Object(o.a)(
          ...
          function () {
            ...
            return t(
              ...
              { staticClass: "wrap" },
              [
                t("h2", { staticClass: "title" }, [n._v("Tài liệu lập trình")]),
                n._v(" "),
                t(
                  "LazyCoreTabs",
                  {
                  ...
                  n._l(n.languages, function (n) {
                    return t("LazyCoreTabsPane", {
                      key: n.slug,
                      attrs: { label: n.name, name: n.slug },
                    });
                  }),
                  1
                ),
                ...
                t(
                  ...
                  [
                    ...
                    n._v(" "),
                    n._l(n.data, function (n) {
                      return t(
                        "el-col",
                        { key: n.slug, attrs: { md: 12, lg: 8, sm: 24 } },
                        [
                          t("LazyResourceCard", {
                            attrs: {
                              type: "tai-lieu",
                ...
                t(
                  "nuxt-link",
                  {
                    ...
                    attrs: {
                      to:
                        "/tai-lieu/tim-kiem?page=1&category=" +
                        n.getCategory.replace("/", ""),
                    },
                  },
                  [
                    n._v("\n    Xem thêm "),
                    t("i", { staticClass: "el-icon-right" }),
                  ]
                ),
              ],
              1
