        ...
        function c(t, n) {
          ...
          return (
            ...
            (r.l = function () {
              var e = r.m,
                t = e.installing;
              r.i > 0 || !f(t.scriptURL, r.g) || performance.now() > r.v + 6e4
                ? ((r.p = t), e.removeEventListener("updatefound", r.l))
                : ((r.P = t), r.h.add(t), r.o.resolve(t)),
                ++r.i,
              ...
              !o && r.j && (c.isUpdate = !0),
                ...
                "installed" === i
                  ? (r.A = self.setTimeout(function () {
                      "installed" === i &&
                        t.waiting === n &&
                        r.dispatchEvent(new u(a + "waiting", c));
                    }, 200))
                  : "activating" === i &&
                    (clearTimeout(r.A), o || r.u.resolve(n));
            }),
            (r.O = function (e) {
              var t = r.P;
            ...
            (r.U =
              ((o = function (e) {
                ...
                return a(r.getSW(), function () {
                  r.h.has(n) &&
                    r.dispatchEvent(
                      new u("message", { data: t, sw: n, originalEvent: e })
                    );
                });
              }),
              function () {
                      ...
                      return (
                        t &&
                          ...
                          Promise.resolve()
                            ...
                            .then(function () {})),
                        r.P && (r.o.resolve(r.P), r.h.add(r.P)),
        ...
        (function () {
          ...
          return (
            ...
            (t.dispatchEvent = function (e) {
              e.target = this;
              for (var t, n = v(this.B(e.type)); !(t = n()).done; )
                (0, t.value)(e);
            }),
            (t.B = function (e) {
